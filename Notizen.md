...
## TODO:
* Splashscreen-Implementierung funktioniert aktuell nicht vernünftig. Wenn das Gerät gestartet wird, wird der Splashscreen angezeigt, doch dann wird nicht weiter initialisiert. Das Gerät verbindet sich nicht mit dem WLAN und fängt auch nicht an das Standard-Plugin zu laden.
...
* GameOfLife Standard-Delay setzen auf 800 ms
